...
mentorship of tech and the love of sharing tech.`,
  ...
  /** Placeholder member portraits above the next section */
  memberPhotos: [
    { seed: 'a', alt: 'Member portrait 1' },
    { seed: 'b', alt: 'Member portrait 2' },
    { seed: 'c', alt: 'Member portrait 3' },
    { seed: 'd', alt: 'Member portrait 4' },
  ],
}
...
export const press = {
  ...
  articles: [
    { title: 'The soul of Silicon Valley', source: 'Financial Times', tone: 'lavender' as const },
    { title: 'How a nerd collective pranked the tech press', source: 'Slate', tone: 'blue' as const },
    { title: 'First Bitcoin ATM in Silicon Valley', source: 'Palo Alto Online', tone: 'green' as const },
    { title: 'Tech for laughs at Hack Comedy Night', source: 'The Almanac', tone: 'yellow' as const },
    { title: 'Techies fight to save the Hacker Dojo', source: 'The New York Times', tone: 'rose' as const },
    { title: 'Celebrating 10 Years of Hacker Dojo', source: 'Silicon Valley Voice', tone: 'mint' as const },
    { title: 'Hacker Dojo Interview', source: 'Venture Beat', tone: 'sky' as const },
  ],
}
...
export const board = {
  ...
  members: [
    ...
    { name: 'Marco Palacios', initials: 'MP' },
    { name: 'Eva Carrender', initials: 'EC' },
    { name: 'Peter Theobald', initials: 'PT' },
  ],
  advisorsLabel: 'Board advisors',
  advisors: [
    { name: 'David Weekly', initials: 'DW' },
    { name: 'Mark Stofer', initials: 'MS' },
  ],
}
...
export const location = {
  ...
  mapPlaceholder: 'Map preview — replace with embedded map or image',
}
